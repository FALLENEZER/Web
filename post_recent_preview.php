...
<div class="small__cards__card">
    <img src="http://localhost:8001/static/Photos/<?= $post['img_modifier'] ?>.png" alt="<?= $post['img_modifier'] ?>">
    ...
    <div class="cards__block_author">
        <div class="avatar-name">
            <img src="http://localhost:8001/static/Photos/<?= $post['avatar'] ?>_face.png" alt="<?= $post['avatar'] ?>">
